...
Rather than the ray, we will just draw a line segment, with definite endpoints, and also as usual just call the line segment a line, for brevity.
...
Draw the chord $TU \perp OP$.  Then $P'$ is the point where $TU$ meets $OP$.  From similar triangles $\triangle OTP' \sim \triangle OPT$, so we have:
\[ \frac{OP'}{k} = \frac{k}{OP} \]
